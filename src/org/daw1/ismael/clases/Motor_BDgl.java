 ...
 * @author ismac
 */
public class Motor_BDgl implements Motor{
    ...
    public Motor_BDgl() throws SQLException{
       getWords();
    }
    ...
    public boolean existsWord(String word) {
        try(Connection conn = DriverManager.getConnection(URL);
                PreparedStatement ps = conn.prepareStatement("SELECT palabra from palabras where lang = 'gl' and palabra = ?")){
    ...
    public boolean addWord(String word) {
       try(Connection conn = DriverManager.getConnection(URL);
          PreparedStatement ps = conn.prepareStatement("INSERT INTO palabras (palabra, lang) VALUES (?, 'gl')")){
           ps.setString(1, word.toUpperCase());
    ...
    public boolean removeWord(String word) {
        try(Connection conn = DriverManager.getConnection(URL);
          PreparedStatement ps = conn.prepareStatement("DELETE FROM palabras WHERE palabra = ? AND lang='gl'")){
           ps.setString(1, word.toUpperCase());
